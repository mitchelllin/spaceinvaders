...
FIRE_RATE     = 0.15
# Lowest damage dealt to Alien ships in randomizer
DAMAGE_LOW    = 20
# Highest damage dealt to Alien ships in randomizer
DAMAGE_HIGH   = 50
...
ALIEN_SPEED = 0.8
# difficulty multiplier (0 < float <= 1) that occurs when an Alien dies
ALIEN_SPEED_CHANGE = 0.98
